...
namespace SportNews.Web.Controllers
{
    public class PostsController : Controller
    {
        ...
        public PostsController(SportNewsDbContext context)
        {
            _context = context;
        }
        ...
        {
            var sportNewsDbContext = _context.Posts.Where(p=>p.Team.Name == id);
			var model = new PostUserViewModel();
			model.Posts= _context.Posts.Where(p=>p.Team.Name == id).ToList();
			return View(model);
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Title,Content,CreatedOn,AuthorID")] Post post)
        {
