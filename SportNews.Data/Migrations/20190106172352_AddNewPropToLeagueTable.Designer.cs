...
namespace SportNews.Web.Data.Migrations
{
    ...
    [Migration("20190106172352_AddNewPropToLeagueTable")]
    partial class AddNewPropToLeagueTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportNews.Models.Reply", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SportNews.Models.Role", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("SportNews.Models.Role")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SportNews.Models.User")
                        .WithMany()
